...
def start_text(config: TelegramBotConfig) -> str:
    return (
        "<b>Marine Track</b>\n"
...
def help_text() -> str:
    return (
        ...
        "• <b>🔎 Найти суда</b> — основной сценарий: поиск свежей сцены по default AOI и запуск детекции.\n"
        "• <b>🕒 Сроки снимков</b> — показать доступные сцены; дальше нажмите 📷 или 🔎.\n\n"
...
def status_text(config: TelegramBotConfig, authorized: bool, user_id: int) -> str:
